 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.auth.ValidateRequest,
 *   !proto.auth.ValidateResponse>}
 */
const methodDescriptor_AuthService_Validate = new grpc.web.MethodDescriptor(
  ...
  proto.auth.ValidateResponse,
  /**
   * @param {!proto.auth.ValidateRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.auth.ValidateResponse.deserializeBinary
);


/**
 * @param {!proto.auth.ValidateRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.auth.ValidateResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.auth.ValidateResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.auth.AuthServiceClient.prototype.validate =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/auth.AuthService/Validate',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.auth.ValidateResponse>}
 *     Promise that resolves to the response
 */
proto.auth.AuthServicePromiseClient.prototype.validate =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/auth.AuthService/Validate',
      request,
